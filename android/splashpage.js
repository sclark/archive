...
splashpageurl: "splash/freedomain.co.nr.html",
...
defineheader: '<div style="padding: 5px; color: white; font: bold 16px Verdana; background: black url(images/blockdefault.gif) center center repeat-x;"><a style="position:absolute; top: 2px; right: 5px" href="type_test.html" title="Skip to Content"><img src="images/skip.gif" border="0" width="114px" height="23px" /></a>Snn Emporium is bought to you by HTC (quietly brilliant) and www.freedomain.co.nr ...<a href="www.freedomain.co.nr/linktous.php" target="_blank"><img src="images/www.freedomain.co.nr.gif" width="468" height="60" border="0" alt="Free Domain Name - www.YOU.co.nr!"></a></div>',

//5) cookie setting: ["cookie_name", "cookie_path"]
cookiename: ["splashpagecookie", "path=/snn/"],
